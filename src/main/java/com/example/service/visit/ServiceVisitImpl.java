...
public class ServiceVisitImpl implements IServiceVisit<Tvisit, Integer> {
	...
	/**
	 * @apiNote Metodo que buscara las consultas disponible filtrada por espcialidad
	 *          y estado de acuerdo a los valores enviado por parametro
	...
	public List<Tvisit> getBySpecialityId(Tspeciality tspeciality, Tstatus tstatus) {
		...
		List<Tvisit> tvisits= this.mapperVisit.getBySpecialityId(tspeciality, tstatus);
